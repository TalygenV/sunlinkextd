...
// Local components
import solarPanelObject from "../../../components/data/solarPanelObject.json";
...
import { ImageLoadingState } from "../../../components/ui/loaders";
import { LeafletPanel } from "../../../components/map";
import { ConfigurationDetails } from "../../../components/configuration";
import { OffsetSelection } from "../../../components/manual/OffsetSelection";
import {
  SolarPanelShowcase,
...
} from "../../../components/manual/ManualPanelWrapper";
import ManualPanelDependencies from "../../../components/manual/ManualPanelDependencies";
...
import { getPanelCorners } from "../../../components/utils/mapHelpers";
import {
  getAllPanels,
  getPanelId,
  calculateTotalStats,
...
} from "../../../components/utils/panelHelpers";
import { testPolygonBoundaryChecking } from "../../../components/utils/polygonHelpers";
          ...
          <div className="solar-map-container overflow-visible h-full relative rounded-lg pt-6">
            ...
            >
              ...
              <ManualPanelWrapper
                ...
                onRegionInfoChange={(newRegions: any) => {
