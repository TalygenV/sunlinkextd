...
import { CheckCircle, DollarSign, X } from "lucide-react"; // Added X icon
import React, { useEffect, useLayoutEffect, useState } from "react";
import PlanSelection from "../SolarPlans/PlanSelection";
  ...
  return (
    <div
      ...
      className={`
        ...
        ${isSelected ? "border-indigo-400 ring-2 ring-indigo-400" : ""}
        ${className}
      `}
    >
      {/* Selected indicator */}
      ...
      <div className="flex items-center space-x-3 mb-2">
        <DollarSign
          size={28}
          className={`${isSelected ? "text-indigo-400" : "text-indigo-500"}`}
        />
      ...
      <div className="flex justify-center items-center mt-1 mb-2">
        <p
          className={`text-2xl md:text-3xl lg:text-4xl font-semibold text-white tabular-nums ${
      ...
      <div className="flex justify-center">
        <p
          className={`text-sm ${
            isSelected ? "text-indigo-400" : "text-indigo-400/90"
          }`}
        >
          + $500 down payment
        </p>
        ...
        {option.type === "Cash" ? (
          ...
          <>
            ...
            <p className="text-sm text-gray-400">
              at {option.annualRate}% APR for {option.termYears} years
            </p>
          </>
        )}
      </div>
...
const OverviewStep = ({
  ...
  solarPanelType,
  inverterModel,
  genabilityData, // Add Genability data prop
}) => {
  ...
  return (
    <div className="flex flex-col items-center text-white p-4 md:p-8 max-w-6xl mx-auto  ">
      ...
      <div className="grid grid-cols-1 gap-10 w-full mb-12 mt-[-5dvh]">
        ...
        {/* Right side: Plan Selection reflecting design choices */}
        <div className="flex flex-col mt-4 w-full">
          <PlanSelection
            initialSystemSize={systemSizeKw}
            initialBatteryCount={batteryCount}
            genabilityData={genabilityData} // Pass Genability data
          />
        </div>
      </div>
