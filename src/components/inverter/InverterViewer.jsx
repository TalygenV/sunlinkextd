...
const InverterViewer = ({
  ...
  return (
    <div className="h-full" style={{ position: "relative" }}>
      {/* Rotation Arrows */}
      {!isMobile && (
        <div className="absolute inset-y-0 left-0 flex items-center pl-[15%] pt-[20%]">
          <button
      ...
      {!isMobile && (
        <div className="absolute inset-y-0 right-0 flex items-center pr-[15%] pt-[20%]">
          <button
