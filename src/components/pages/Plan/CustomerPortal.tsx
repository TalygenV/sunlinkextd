...
const CustomerPortal: React.FC<CustomerPortalProps> = ({ 
  ...
  const [messages, setMessages] = useState([
    {
      ...
      message: 'Hi! I\'ve been assigned as your installer. I\'ve reviewed your photos and everything looks great. We should have permits approved within 2-3 weeks.',
    ...
    },
    {
      id: 2,
      sender: 'You',
      message: 'Great to meet you Mike! Do you need any additional information from me?',
      timestamp: '2024-01-20 11:15 AM',
      isFromInstaller: false,
      avatar: customerInfo.name.split(' ').map(n => n[0]).join('')
    },
    {
      id: 3,
      sender: 'Mike Johnson - SunLink Installer',
      message: 'Everything looks good! I\'ll keep you updated on permit status. Feel free to reach out if you have any questions.',
      timestamp: '2024-01-20 2:45 PM',
      isFromInstaller: true,
      avatar: 'MJ'
    }
  ]);
  const [referralCode] = useState('SUNLINK-' + Math.random().toString(36).substr(2, 6).toUpperCase());
  ...
  const notifications = [
    {
      ...
      message: 'Your solar permit application has been submitted to the city. Expected approval in 2-4 weeks.',
      type: 'info',
      date: '2024-01-20',
      read: false
    },
    {
      ...
      message: 'Mike Johnson has been assigned as your certified installer. He will contact you soon.',
      type: 'success',
      date: '2024-01-19',
      read: true
    },
    {
      ...
      message: 'Your home photos have been reviewed and approved. Moving to permit phase.',
      type: 'success',
      date: '2024-01-18',
      read: true
    },
    {
      ...
      message: 'Thank you for choosing SunLink Solar! Your journey to clean energy begins now.',
      type: 'info',
      date: '2024-01-15',
      read: true
    }
  ...
  const handleSendMessage = useCallback(() => {
    ...
    const userAvatar = customerInfo.name.split(' ').map(n => n[0]).join('');
    ...
    setTimeout(() => {
      const installerResponse = {
        id: Date.now() + 1,
        sender: 'Mike Johnson - SunLink Installer',
        message: 'Thanks for your message! I\'ll get back to you with more details soon.',
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-gotham-light mb-2">Welcome Back, {customerInfo.name.split(' ')[0]}!</h2>
            <p className="text-blue-100">Your solar installation is in progress</p>
          </div>
          <div className="text-right">
            <div className="text-sm text-blue-200">System Size</div>
            <div className="text-3xl font-gotham-bold">{systemDetails.size} kW</div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white/10 border border-white/20 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <div className="text-xl font-gotham-bold text-white">26 Panels</div>
            </div>
          </div>
          <div className="text-sm text-gray-400">{systemDetails.size} kW System</div>
        </div>
        ...
        <div className="bg-white/10 border border-white/20 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <div className="text-xl font-gotham-bold text-white">{systemDetails.batteryCount} Units</div>
            </div>
          </div>
          <div className="text-sm text-gray-400">{systemDetails.batteryType}</div>
        </div>
        ...
        <div className="bg-white/10 border border-white/20 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <div className="text-xl font-gotham-bold text-white">14,300 kWh</div>
            </div>
          </div>
      ...
      <div className="bg-white/10 border border-white/20 rounded-xl overflow-hidden">
        <div className="p-6 border-b border-white/20">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-gotham-medium text-white">Confirmed Solar Layout</h3>
          </div>
          <p className="text-sm text-gray-400 mt-1">Your custom solar panel design and placement</p>
        </div>
        <div className="h-96 bg-gray-800 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-gray-800">
            <div className="text-center">
              ...
              <p className="text-gray-300 font-gotham-medium">Interactive Solar Layout</p>
              <p className="text-sm text-gray-500 mt-1">Mapbox integration will display your confirmed solar design</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/10 border border-white/20 rounded-xl p-6">
        <h3 className="text-lg font-gotham-medium text-white mb-6">Installation Progress</h3>
            ...
            <div key={step.id} className="flex items-start space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="text-sm font-gotham-medium text-white">{step.title}</h4>
      ...
      {/* ROI Preview */}
      <div className="bg-white/10 border border-white/20 rounded-xl p-6">
        <h3 className="text-lg font-gotham-medium text-white mb-6">Your Solar Investment</h3>
  ...
  const MessagesTab = () => (
    <div className="bg-white/10 border border-white/20 rounded-xl h-[600px] flex flex-col">
      ...
      <div className="p-6 border-b border-white/20 flex-shrink-0">
        ...
        <p className="text-sm text-gray-400">Chat with your installer and support team</p>
      </div>

      {/* Messages List */}
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        {messages.map((message) => (
          <div key={message.id} className={`flex ${message.isFromInstaller ? 'justify-start' : 'justify-end'}`}>
            <div className={`flex items-start space-x-3 max-w-xs lg:max-w-md ${message.isFromInstaller ? '' : 'flex-row-reverse space-x-reverse'}`}>
              ...
              <div className={`rounded-lg p-3 ${message.isFromInstaller ? 'bg-white/10 border border-white/20' : 'bg-blue-600 text-white'}`}>
                <div className={`text-sm font-gotham-medium mb-1 ${message.isFromInstaller ? 'text-white' : 'text-white'}`}>
                  {message.isFromInstaller ? message.sender : 'You'}
                </div>
                <div className={`text-sm ${message.isFromInstaller ? 'text-gray-300' : 'text-white'}`}>
                  {message.message}
                </div>
                <div className={`text-xs mt-2 ${message.isFromInstaller ? 'text-gray-500' : 'text-blue-100'}`}>
                  {message.timestamp}
                </div>
              </div>
            </div>
  ...
  const DocumentsTab = () => (
    <div className="bg-white/10 border border-white/20 rounded-xl">
      <div className="p-6 border-b border-white/20">
        ...
        <p className="text-sm text-gray-400">All your solar installation documents in one place</p>
      </div>

      <div className="p-6">
        <div className="space-y-4">
          {documents.map((doc) => (
            <div key={doc.id} className="flex items-center justify-between p-4 border border-white/20 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <div className="flex items-center space-x-3">
                <span className={`px-2 py-1 rounded-full text-xs font-gotham-medium ${
                  doc.status === 'Signed' || doc.status === 'Final' || doc.status === 'Active' 
  ...
  const NotificationsTab = () => (
    <div className="bg-white/10 border border-white/20 rounded-xl">
      <div className="p-6 border-b border-white/20">
        ...
        <p className="text-sm text-gray-400">Stay updated on your solar installation progress</p>
      </div>

      <div className="p-6">
        <div className="space-y-4">
          {notifications.map((notification) => (
            <div key={notification.id} className={`p-4 border rounded-lg ${notification.read ? 'border-white/20 bg-white/5' : 'border-blue-500/30 bg-blue-500/10'}`}>
              <div className="flex items-start space-x-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  notification.type === 'success' ? 'bg-green-500/20 border border-green-500/30' : 
                  notification.type === 'warning' ? 'bg-yellow-500/20 border border-yellow-500/30' : 'bg-blue-500/20 border border-blue-500/30'
                }`}>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <h4 className="font-gotham-medium text-white">{notification.title}</h4>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-6 text-white">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h2 className="text-2xl font-gotham-light">Refer Friends & Earn Rewards</h2>
        </div>
        <p className="text-green-100 mb-6">
          Share the benefits of solar with friends and family. You both save money when they go solar with SunLink!
        </p>
      ...
      {/* Your Referral Code */}
      <div className="bg-white/10 border border-white/20 rounded-xl p-6">
        <h3 className="text-lg font-gotham-medium text-white mb-4">Your Referral Code</h3>
        
        <div className="bg-white/5 border border-white/20 rounded-lg p-4 mb-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-gotham-bold text-white mb-1">{referralCode}</div>
              <div className="text-sm text-gray-400">Share this code with friends</div>
            </div>
            <button
      ...
      {/* How It Works */}
      <div className="bg-white/10 border border-white/20 rounded-xl p-6">
        <h3 className="text-lg font-gotham-medium text-white mb-6">How It Works</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h4 className="font-gotham-medium text-white mb-2">1. Share Your Code</h4>
            <p className="text-sm text-gray-400">Send your referral code to friends interested in solar</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="font-gotham-medium text-white mb-2">2. Friend Goes Solar</h4>
            <p className="text-sm text-gray-400">They use your code and complete their solar installation</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="font-gotham-medium text-white mb-2">3. Both Earn Rewards</h4>
            <p className="text-sm text-gray-400">You get $500, they save $500 on their installation</p>
          </div>
        </div>
      </div>
      ...
      {/* Referral History */}
      <div className="bg-white/10 border border-white/20 rounded-xl p-6">
        <h3 className="text-lg font-gotham-medium text-white mb-4">Referral History</h3>
        
        <div className="text-center py-8">
          <Users className="w-12 h-12 text-gray-500 mx-auto mb-4" />
          <p className="text-gray-400">No referrals yet</p>
          <p className="text-sm text-gray-500 mt-1">Start sharing your code to see your referrals here</p>
        </div>
      </div>
    </div>
  );
  ...
  const SettingsTab = () => (
    <div className="space-y-6">
      {/* Profile Settings */}
      <div className="bg-white/10 border border-white/20 rounded-xl p-6">
        <h3 className="text-lg font-gotham-medium text-white mb-6">Profile Settings</h3>
        
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-gotham-medium text-gray-300 mb-2">Full Name</label>
              <div className="flex items-center space-x-3">
            ...
            <div>
              <label className="block text-sm font-gotham-medium text-gray-300 mb-2">Email Address</label>
              <div className="flex items-center space-x-3">
          ...
          <div>
            <label className="block text-sm font-gotham-medium text-gray-300 mb-2">Installation Address</label>
            <div className="flex items-center space-x-3">
      ...
      <div className="bg-white/10 border border-white/20 rounded-xl p-6">
        <h3 className="text-lg font-gotham-medium text-white mb-6">Notification Preferences</h3>
        
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="font-gotham-medium text-white">Email Notifications</div>
              <div className="text-sm text-gray-400">Receive updates about your installation</div>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-400">Get text messages for important updates</div>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="font-gotham-medium text-white">Marketing Communications</div>
              <div className="text-sm text-gray-400">Receive solar tips and company updates</div>
            </div>
            <button className="bg-blue-600 relative inline-flex h-6 w-11 items-center rounded-full">
              <span className="translate-x-6 inline-block h-4 w-4 transform rounded-full bg-white transition" />
            </button>
