...
export default function Hero() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden border-b-0" id="home">
      {/* Background Image */}
      <motion.div
      ...
      <div className="relative z-10 container-fluid px-6 sm:px-8 lg:px-12 pt-32 pb-16 min-h-[100vh] flex flex-col items-center justify-center text-center">
        <AnimatePresence mode="wait">
          {!showForm ? (
            <div className="animate-fade-in space-y-6 max-w-5xl w-full">
              <div className="grid md:grid-cols-2 lg:gap-12 gap-8 items-center">
                <div className="text-left">
                  ...
                  >
                    ...
                    >
                      Create your custom solar setup in minutes with our
                      advanced design tool. Get instant cost estimates and see
                      your savings in real-time.
                    </motion.p>
            ...
            <DesignForm key="design-form" onBack={() => setShowForm(false)} />
          )}
        </AnimatePresence>
