      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-white/10 bg-black/30">
          <div className="flex items-center gap-3">
            <div
              className={`p-2 rounded ${typeStyles.bgColor} ${typeStyles.textColor}`}
            >
            ...
            <div>
              ...
              <p className="text-sm text-white/60">
                Added on {formatDate(document.dateAdded)}
              </p>
            </div>
          </div>
          ...
          <div className="w-full h-full flex items-center justify-center">
            {isPDF ? (
              ...
              <div className="w-full h-full p-4 flex flex-col items-center justify-center">
                <div
                  className={`w-32 h-32 ${typeStyles.bgColor} rounded-lg flex items-center justify-center mb-4`}
                >
                  <span
                    className={`text-4xl font-bold ${typeStyles.textColor}`}
                  >
