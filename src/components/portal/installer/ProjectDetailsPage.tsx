...
export const ProjectDetailsPage: React.FC<ProjectDetailsPageProps> = ({
        ...
        if (!isAdmin) {
          ...
          if (userSnapshot.exists()) {
            ...
            setProjectData({
              ...
              customerName:
                userData.name ||
                installerProjectData.customerName ||
                "Unknown Customer",
  ...
  const calculateSystemSize = (): number => {
    ...
    const panelCount =
      projectData.totalManualPanels ?? projectData.panels?.length ?? 0;
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white">
                    {projectData.phoneNumber || "Not provided"}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black/30 rounded-lg border border-white/5 p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white">
                    {projectData.totalManualPanels || "0"} Panels
                  </span>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">
                      {formatDate(projectData.assignedDate)}
                    </p>
                  </div>
                </div>
              </div>
