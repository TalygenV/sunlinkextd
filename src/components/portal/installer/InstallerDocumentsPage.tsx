...
export const InstallerDocumentsPage: React.FC<InstallerDocumentsPageProps> = ({
  isAdmin = false,
}) => {
    ...
    const fetchDocuments = async () => {
      ...
      try {
        ...
        if (!isAdmin) {
          ...
          const installerProjectRef = dbRef(
            db,
        ...
        if (snapshot.exists()) {
          ...
          const docsArray: DocumentInfo[] = Object.keys(docsData).map(
            (key) => ({
              id: key,
              ...docsData[key],
        ...
        <div className="bg-black/20 backdrop-blur-lg rounded-xl border border-white/10 p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-white/60">Customer: {customerName}</p>
            </div>
